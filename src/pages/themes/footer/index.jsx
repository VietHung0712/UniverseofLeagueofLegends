            ...
            <div className={styles.ctr}>
                <div className={styles.take}>
                    <div>
                        ...
                        <a target="_blank" rel="noopener noreferrer"
                            href="https://www.leagueoflegends.com/en-us/?utm_medium=card1%2Bplayruneterra.com&utm_source=riotbar">
                ...
                <div className={styles.made}>
                    <div className={styles.socials__list}>
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-twitter-x"
                                viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-tiktok"
                                viewBox="0 0 16 16">
                                <path
